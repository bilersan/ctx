...
// copilotInstructions is the GitHub Copilot integration template for
// .github/copilot-instructions.md.
//
// It bootstraps Copilot Chat (agent mode) by pointing it to context
// files and AGENT_PLAYBOOK.md for detailed workflow instructions.
